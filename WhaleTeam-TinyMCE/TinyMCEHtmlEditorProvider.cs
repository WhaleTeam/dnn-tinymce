...
namespace WhaleTeam.TinyMCE
{
    ...
    using WhaleTeam.TinyMCE.Web;

    #endregion

    public class TinyMCEHtmlEditorProvider: HtmlEditorProvider
    {
        ...
        /// </summary>
        private Web.Textarea htmlEditorControl;
        ...
        {
            get { return this.htmlEditorControl; }
        }
        ...
        {
            this.htmlEditorControl = new Web.Textarea { ID = this.ControlID };
        }
    }
}
